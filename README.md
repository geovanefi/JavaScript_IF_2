...
# JavaScript Básico - IF e Else detalhado
## Uso simples do IF e Else
<p> Aqui também é possivel ver como se cria elemento no document.</p>
obs: Fácil compreensão nas comparacoes, arrays e img.setAttribute . 

### Link da aplicação:

<a href="https://geovanefi.github.io/DesenvolvedorWeb/ProjectJavaScript2/ProjetoJS02.html"> Verificador de Idade </a>
